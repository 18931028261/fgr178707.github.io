...
ECHO    # 03、网络异常修复                # 04、直接删除文件不进入回收站
...
ECHO    # 13、清理应用商店缓存            # 14、去除文字“快捷方式” 
ECHO    # 15、Win11旧版右键菜单设置器
ECHO. 
ECHO    #-----------------------------------------------------------------#
ECHO                                                        输入2进入二页 #
ECHO                                                        输入3进入三页 #
...
CLS
ECHO. 
ECHO. 【Win11恢复旧版右键菜单v1.1】 by IT豪哥-电脑教程网 at 2023.1.7
ECHO.  
ECHO.           功能由 哔哩哔哩 IT豪哥-电脑软件教程 提供
ECHO. 
ECHO. ==================================================================================
